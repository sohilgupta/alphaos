...
US_TICKERS = [
    'AAOI','ABAT','ACHR','ACMR','ADI','AEHR','AEVA','ALAB','ALB','AMAT','AMD','AMKR',
    'AMPX','AMRK','AMT','AMZN','ANET','ANSS','APD','APH','APLD','APP','AREC','ARKX',
    'ARM','ARR','ASML','ASPI','ASTS','ASX','ATS','AVAV','AVGO','AXTI','BA','BE','BETR',
    'BITF','BKKT','BKSY','BLDP','BMNR','BWXT','CAMT','CAR','CCJ','CDNS','CDTX','CEG',
    'CELC','CGNX','CIEN','CIFR','COHR','COIN','CRDO','CRML','CRS','CRWV','CSCO','DDOG',
    'DE','DELL','DLR','DRS','ENR','ENS','ENTG','EOSE','EQIX','ESLT','ETN','FARO','FCX',
    'FIGR','FIX','FLEX','FLNC','FN','FORM','FTAI','GD','GEV','GLW','GOOGL','HON','HOOD',
    'HPQ','HSAI','HUT','HXL','ICHR','IDR','INOD','INTC','INVZ','IONQ','IRDM','IREN',
    'ISRG','JBL','JOBY','KEYS','KLAC','KOD','KRMN','KTOS','LAC','LAR','LAZR','LECO',
    'LEU','LHX','LIDR','LIN','LITE','LMT','LPTH','LRCX','LTBR','LTRX','LUNR','LWLG',
    'MBLY','MDB','MDT','METC','MIR','MOD','MP','MPOW','MPWR','MRCY','MRVL','MSTR','MTZ',
    'MU','MVST','MXL','NB','NBIS','NET','NNE','NOC','NOK','NTAP','NU','NVDA','NVMI',
    'NVTS','NXE','OII','OKLO','OMCL','ON','ONDS','OPEN','OPTX','ORCL','OSCR','OUST',
    'PANW','PATH','PDYN','PEGA','PL','PLTR','PONY','POWL','PPL','PPTA','PRCT','PRME',
    'PSIX','PTC','PWR','QBTS','QCOM','QS','QUBT','RCAT','RDDT','RDW','REEMF','RGTI',
    'RIOT','RKLB','RKT','RMBS','ROK','RTX','SATL','SATS','SEI','SERV','SGML','SKYT',
    'SLI','SMCI','SMR','SMTC','SNDK','SNOW','SNPS','SOFI','STM','STX','SYK','SYM','TDY',
    'TEAM','TER','TLN','TMC','TMQ','TMRC','TNGX','TOWCF','TSEM','TSLA','TSM','TXN','TXT',
    'UAMY','UAVS','UEC','UFO','UI','UMAC','URC','UROY','USAR','UUUU','VICR','VMI','VOYG',
    'VRT','VSAT','VST','WDC','WPM','WULF','WYFI','ZBRA','ZETA',
]
